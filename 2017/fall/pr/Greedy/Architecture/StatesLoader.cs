...
namespace Greedy.Architecture
{
	public static class StatesLoader
	{
		...
		{
			var map = mapGoalEnergyPositionChests[0].Split(new[] {"\r\n"}, StringSplitOptions.RemoveEmptyEntries);
			...
			var goalEnergy = mapGoalEnergyPositionChests[1].Split(new[] {"\r\n"}, StringSplitOptions.RemoveEmptyEntries)[1]
				.Split(' ');
			...
			var positionXY = mapGoalEnergyPositionChests[2].Split(new[] {"\r\n"}, StringSplitOptions.RemoveEmptyEntries)[1]
				.Split(' ');
